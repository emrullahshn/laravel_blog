...
class CategoriesController extends BackendController
{
  ...
  public function store(CategoryStoreRequest $request)
  {
    ...
    return redirect('/backend/categories')->with('message','Kategori başarılı bir şekilde oluşturuldu.');
  }
  ...
  public function update(CategoryUpdateRequest $request, $id)
  {
    ...
    return redirect('/backend/categories')->with('message','Kategori başarılı bir şekilde güncellendi.');
  }
  ...
  public function destroy(CategoryDestroyRequest $request, $id)
  {
    ...
    return redirect('/backend/categories')->with('message','Kategori başarılı bir şekilde silindi.');
  }
}
